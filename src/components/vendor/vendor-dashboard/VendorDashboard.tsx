...
//             setDashboardData({
//               totalEventsHosted: data?.data.totalEvents,
//               totalTicketsSold: data?.data.totalTickets,
//               totalRevenue: data?.data.totalRevenue,
//               totalBookings: data?.data.totalBookings,
//               transactions: data?.data.transactions,
//               recentBookings: data?.data.recentBookings,
//               // recentTickets: mockRecentTickets,
//             })           
//             setLoading(false)
//           },
//           onError: (error) => {
...
//         <WalletTransactionGraph transactions={dashboardData.transactions || []} period={selectedPeriod} theme="light" />
...
//                     </div>
//                     <div>
//                       <h4 className="font-medium text-gray-900">{booking?.service?.serviceTitle}</h4>
//                       <div className="flex items-center gap-2 text-sm text-gray-600">
//                         <span>{booking?.clientName}</span>
//                         <span>•</span>
//                         <span>{formatDate(booking?.date[0])}</span>
//                       </div>
//                     </div>
//                   </div>
...
//                     </div>
//                     <div>
//                       <h4 className="font-medium text-gray-900">{ticket?.eventName}</h4>
//                       <div className="flex items-center gap-2 text-sm text-gray-600">
//                         <span>{ticket.ticketsSold} tickets</span>
//                         <span>•</span>
...
//                   </div>
//                   <div className="text-right">
//                     <div className="font-bold text-gray-900">₹{ticket?.revenue?.toLocaleString()}</div>
//                     <div className="text-xs text-gray-500">{ticket?.ticketsSold} sold</div>
//                   </div>
//                 </div>
//               ))}
//             </div>
