...
import Img1 from '@/assets/images/Loginimage.jpeg'
import {  IVendor, UserRoles } from "@/types/User"
            ...
            <div className="w-full max-w-md">
              ...
              <motion.form onSubmit={handleSubmit} className="space-y-4">
                ...
                <motion.div variants={itemVariants} className="flex items-center justify-between">
                  ...
                  <a onClick={() => navigate("/vendor/forgot-password")} className="text-sm text-blue-600 hover:underline">
                    Forgot password?
                  </a>
                </motion.div>
                ...
                <motion.div variants={itemVariants} className="text-center text-sm mt-6">
                  ...
                  <a onClick={()=>navigate('/vendor/signup')} className="text-blue-600 hover:underline">
                    Sign up
                  </a>
                </motion.div>
              </motion.form>
